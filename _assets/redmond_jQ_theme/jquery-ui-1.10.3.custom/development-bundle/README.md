...
Or visit the [Using jQuery UI Forum](http://forum.jquery.com/using-jquery-ui) for discussions and questions.
...
pull request for that branch. Don't mix unrelated changes. 
